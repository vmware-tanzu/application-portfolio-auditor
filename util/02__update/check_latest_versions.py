...
if __name__ == '__main__':
    ...
    asyncio.run(check_latest_versions([
        ...
        (check_github, 'jeremylong/DependencyCheck', r'.*/tag/v(.+)', 'OWASP DC', OWASP_DC_VERSION, '9.0.9'),
        ...
        (check_github, 'AlDanial/cloc', r'.*/tag/v(.+)', 'CLOC', CLOC_VERSION, '2.00'),
        ## Windup: Versions from 6.2.x do not allow multiple targets
        (check_github, 'windup/windup-distribution', r'.*/tag/(.+).Final', 'Windup', WINDUP_VERSION, '6.3.6'),
