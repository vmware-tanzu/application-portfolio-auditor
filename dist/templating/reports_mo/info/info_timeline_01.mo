...
<body>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <p style="margin-bottom: 0px;">Chart visualizing the execution timeline {{AUDIT_DURATION}} of the <span class="badge bg-secondary">{{TOOLS_COUNT}}</span> tools used, including <span style="color:#1f77b4">preparation</span>, <span style="color:#ff7f0e">analysis</span>, and result <span style="color:#2ca02c">extraction</span> phases.<br/><br/></p>
