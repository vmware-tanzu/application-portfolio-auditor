...
<body>
  ...
  <div class="bd-masthead py-3 mb-3" id="tools" role="main">
    <div class="container">
      <div class="d-flex">
          <a href="./../09__FindSecBugs/" rel="noreferrer" target="_blank"><img class="mr-3 me-3" src="./../static/img/fsb.png" height="50" width="50" alt="Find Security Bugs"></a>
          <div>
  ...
  <div class="container">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">Find Security Bugs</li>
