...
<body>
  ...
  <div class="bd-masthead py-3 mb-3" id="tools" role="main">
    <div class="container">
      <div class="d-flex">
          <a href="./../05__OWASP_DC/" rel="noreferrer" target="_blank"><img class="mr-3 me-3" src="./../static/img/owasp.svg" height="50" width="50" alt="Open Web Application Security Project Dependency-Check"></a>
          <div>
  ...
  <div class="container">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">OWASP Dependency-Check</li>
              ...
              <div class="card border-0" style="background-color: #333333; color: #ffffff;">
                <div class="card-body">
                  <div class="row align-items-center">
                    ...
                    <div class="col-6">
                      <h6 class="text-end"><span class="h3 m-0">{{ODC__VULN_LIBS}}&nbsp;</span><span class="m-0 h6">out of</span><span class="h3 m-0">&nbsp;{{ODC__ALL_LIBS}}</span></h6>
                    </div>
                  </div>
                  <div class="row align-items-center" style="margin-left: 0px; margin-right: 0px;">
                    <div class="progress" style="padding-left: 0px; padding-right: 0px;">
                      <div class="progress-bar" role="progressbar" style="width: {{ODC__PERCENT_VULN_LIBS}}%; background-color: var(--findingPurple);padding-top: 2px" aria-valuenow="{{ODC__PERCENT_VULN_LIBS}}" aria-valuemin="0" aria-valuemax="100">{{ODC__PERCENT_VULN_LIBS}}%</div>
                    </div>
                  </div>
                </div>
              </div>
  ...
  <div class="container">
    <div class="ratio ratio-1x1">
      <iframe id="iframeReport" class="embed-responsive-item" src="./{{APP}}_dc_report.html" allowfullscreen></iframe>
    </div>
  </div>
  <!-- /.container -->
  ...
  <script>
    ...
    const vulns_total = {{ODC__VULNS_ALL}}
    const vulns_low = {{ODC__VULNS_LOW}}
    const vulns_medium = {{ODC__VULNS_MEDIUM}}
    const vulns_high = {{ODC__VULNS_HIGH}}
