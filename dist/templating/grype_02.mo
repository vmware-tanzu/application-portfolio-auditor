  ...
  function drawTable(data) {
    ...
    const vulns_total = {{GRYPE__VULNS_ALL}}
    const vulns_low = {{GRYPE__VULNS_LOW}}
    const vulns_medium = {{GRYPE__VULNS_MEDIUM}}
    const vulns_high = {{GRYPE__VULNS_HIGH}}
    const vulns_critical = {{GRYPE__VULNS_CRITICAL}}
